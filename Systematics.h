...
void systematics(TFile* OutputFile){
  ...
  LeftBkgSmall   = SafelyOpenRootfile("OutputFileBetterBkg3to8_UncorrBckSmallFitRange.root");
  LeftBkgWide    = SafelyOpenRootfile("OutputFileBetterBkg3to8_UncorrBckWideFitRange.root");
  ...
  if (OutputFileBetterBkg3to8_HigherFit->   IsOpen() ) printf("OutputFileBetterBkg3to8_HigherFit opened successfully\n");
  ...
  if (OutputFileBetterBkg3to8_SmallFit->      IsOpen() ) printf("OutputFileBetterBkg3to8_SmallFit opened successfully\n");
  ...
  if (OutputFileBetterBkg3to8_LowerRebinning->    IsOpen() ) printf("OutputFileBetterBkg3to8_LowerRebinning opened successfully\n");
  ...
  for (int i = 1; i <= numberbins; i++) {
    if(i == 1 || i >= numberbins-2){
      ...
      hCorrYield_RelativSyserror->  SetBinContent(i, 0.);

      hCorrYield_IntSysError->      SetBinContent(i, 0.);
      hCorrYield_IntSysError->      SetBinError(i, 0.);

      hCorrYield_FitSysErrro->      SetBinContent(i, 0.);
      hCorrYield_FitSysErrro->      SetBinError(i, 0.);

      hCorrYield_RebinningSysError->SetBinContent(i, 0.);
      hCorrYield_RebinningSysError->SetBinError(i, 0.);

      hCorrYield_CorrBkgSysError->  SetBinContent(i, 0.);
      hCorrYield_CorrBkgSysError->  SetBinError(i, 0.);

      hCorrYield_LeftBkgySerror->   SetBinContent(i, 0.);;
      hCorrYield_RelativSyserror->  SetBinError(i, 0.);
      continue;
    ...
    hCorrYield_SysError->  SetBinContent(i, hCorrYieldME->GetBinContent(i));
    hCorrYield_SysError->         SetBinError(i, vFinalSys[i-2]*hCorrYieldME->GetBinContent(i));

    hCorrYield_RelativSyserror->  SetBinContent(i, vFinalSys[i-2]);

    hCorrYield_IntSysError->      SetBinContent(i, vCountSys[i-2]);
    hCorrYield_IntSysError->      SetBinError(i, 0.);

    hCorrYield_FitSysErrro->      SetBinContent(i, vParamSys[i-2]);
    hCorrYield_FitSysErrro->      SetBinError(i, 0.);

    hCorrYield_RebinningSysError->SetBinContent(i, vBGFitSys[i-2]);
    hCorrYield_RebinningSysError->SetBinError(i, 0.);

    hCorrYield_CorrBkgSysError->  SetBinContent(i, vCorrBkgSys[i-2]);
    hCorrYield_CorrBkgSysError->  SetBinError(i, 0.);
  ...
  hCorrYield_RelativSyserror->Print("all");
