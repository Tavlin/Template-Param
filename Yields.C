...
void Yields(TString PicFormat = "png", TString SaveAppendix = ""){
    ...
    SetHistogramProperties(hCorrYield_HigherFitSysUncertainty, "pt", "relative sys. Unsicherheit (%)", 2, 1.4, 12.);

    hCorrYield_SmallFitSysUncertainty         = (TH1D*) BetterBkg3to8->Get("hCorrYield_SmallFitSysUncertainty");
    SetHistogramProperties(hCorrYield_SmallFitSysUncertainty, "pt", "relative sys. Unsicherheit (%)", 1, 1.4, 12.);

    hCorrYield_HigherIntSysUncertainty        = (TH1D*) BetterBkg3to8->Get("hCorrYield_HigherIntSysUncertainty");
    SetHistogramProperties(hCorrYield_HigherIntSysUncertainty, "pt", "relative sys. Unsicherheit (%)", 2, 1.4, 12.);

    hCorrYield_SmallIntSysUncertainty         = (TH1D*) BetterBkg3to8->Get("hCorrYield_SmallIntSysUncertainty");
    SetHistogramProperties(hCorrYield_SmallIntSysUncertainty, "pt", "relative sys. Unsicherheit (%)", 1, 1.4, 12.);

    hCorrYield_LowerRebinningSysUncertainty   = (TH1D*) BetterBkg3to8->Get("hCorrYield_LowerRebinningSysUncertainty");
    SetHistogramProperties(hCorrYield_LowerRebinningSysUncertainty, "pt", "relative sys. Unsicherheit (%)", 1, 1.4, 12.);

    hCorrYield_HigherRebinningSysUncertainty  = (TH1D*) BetterBkg3to8->Get("hCorrYield_HigherRebinningSysUncertainty");
    SetHistogramProperties(hCorrYield_HigherRebinningSysUncertainty, "pt", "relative sys. Unsicherheit (%)", 2, 1.4, 12.);

    hCorrYield_NNMethodSysUncertainty         = (TH1D*) BetterBkg3to8->Get("hCorrYield_NNMethodSysUncertainty");
    SetHistogramProperties(hCorrYield_NNMethodSysUncertainty, "pt", "relative sys. Unsicherheit (%)", 2, 1.4, 12.);

    hCorrYield_SingleBkgSysUncertainty        = (TH1D*) BetterBkg3to8->Get("hCorrYield_SingleBkgSysUncertainty");
    SetHistogramProperties(hCorrYield_SingleBkgSysUncertainty, "pt", "relative sys. Unsicherheit (%)", 1, 1.4, 12.);
     ...
     */
     ...
     TLegend* legFitSysUncertainty = new TLegend(0.3, 0.7, 0.7, 0.9);
     ...
     hCorrYield_HigherFitSysUncertainty->GetYaxis()->SetRangeUser(-25.7, 25.7);
    ...
    //  c1->Clear();
     ...
     TLegend* legIntSysUncertainty = new TLegend(0.3, 0.7, 0.7, 0.9);
     ...
     hCorrYield_HigherIntSysUncertainty->GetYaxis()->SetRangeUser(-25.7, 25.7);
     ...
     TLegend* legRebinningSysUncertainty = new TLegend(0.3, 0.7, 0.7, 0.9);
     ...
     TLegend* legBkgVariationSysUncertainty = new TLegend(0.3, 0.7, 0.7, 0.9);
